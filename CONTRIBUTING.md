...
Welcome to `fraud` contributor's guide.
...
If you experience bugs or general issues with `fraud`, please have a look
...
You can help improve `fraud` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`fraud` documentation uses [Sphinx] as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution.

:::{tip}
    Please notice that the [GitHub web interface] provides a quick way of
    propose changes in `fraud`'s files. While this mechanism can
...
```{todo} Please include a reference or explanation about the internals of the project.
   ...
   quickly.
```
It is highly recommended to read all the README content present in the
[repository] before starting to contribute to `fraud`. This will give you a
good overview of the project and its goals. And, also, the structure of the
...
```
conda create -n fraud python=3 six virtualenv pytest pytest-cov
conda activate fraud
```

However, the best way is using the environment file provided in the repository and
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/fraud.git
   cd fraud
   ```
...
5. Install [pre-commit]:
   ...
   `fraud` comes with a lot of hooks configured to automatically help the
